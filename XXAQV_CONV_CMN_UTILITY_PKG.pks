...
-- ****************************************************************************************************************/
   TYPE gt_conv_cmn_utility_typ IS
      TABLE OF xxaqv_conv_cmn_utility_stg%rowtype INDEX BY BINARY_INTEGER;
...
-- ****************************************************************************************************************/
   PROCEDURE print_output (
      ...
      ,p_batch_run       IN   NUMBER   DEFAULT NULL
      ,p_stage           IN   VARCHAR2
...
-- * Purpose   : This function will validate organization value from hr_all_organization_units                    *
-- *             and return organization_id                                                                       *
-- ****************************************************************************************************************/
   FUNCTION validate_hr_all_org (
