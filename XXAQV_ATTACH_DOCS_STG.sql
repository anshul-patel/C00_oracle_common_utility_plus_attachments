...
-- *--------------------------------------------------------------------------------------------------------------*
-- * 0.1         CTS               07/01/2020     Initial Version                                                 *
-- ***************************************************************************************************************/
CREATE TABLE xxaqv.xxaqv_attach_docs_stg ( x_pk1_value                VARCHAR2(500)
                                         ...
                                         , x_category_id              NUMBER          -- Category ID
                                         , x_datatype_id              NUMBER          -- Type of Format
                                         ...
                                         , request_id                 NUMBER  
										 , r12_attached_document_id   NUMBER
										 , r12_document_id            NUMBER);
